...
def init_model(params):
    ...
    a1_model_path = "/home/mert/gym_learning/models/a1_flat/model_300.pt"
    comar_model_path = "/home/mert/gym_learning/models/comar/smoothed.pt"
    
    model_path = comar_model_path
...
def load_asset():
    ...
    a1_asset_file = "a1/urdf/a1.urdf"
    comar_asset_file = "comar/urdf/comar_a1.urdf"
...
while True:
    ...
    commands[:, 0] = cmd_command.linear.x
    commands[:, 1] = cmd_command.linear.y
    commands[:, 2] = cmd_command.angular.z
